...
export const NavigationLayout: React.FC<Props> = ({ children }) => {
  ...
  const items: NavigationItem[] = [
    ...
    {
      key: '/organizations/:organizationId/trips/new',
      label: 'Trip Planning',
      position: 'topbar',
      ...
      onClick: () =>
        goTo(
          '/organizations/:organizationId/trips/new'.replace(
            ':organizationId',
            organization.id,
          ),
        ),
    ...
    {
      key: '/organizations/:organizationId/trips',
      label: 'Trip List',
      position: 'topbar',
      ...
      onClick: () =>
        goTo(
          '/organizations/:organizationId/trips'.replace(
            ':organizationId',
            organization.id,
          ),
        ),
    ...
    {
      key: '/organizations/:organizationId/assistant',
      ...
      onClick: () =>
        goTo(
          '/organizations/:organizationId/assistant'.replace(
            ':organizationId',
            organization.id,
          ),
        ),
